(function($) { // Hide scope, no $ conflict
	...
	SUPER.init_popups.slide_in = function( $this, $settings ) {
        ...
        var $interval = setInterval(function(){
            if($wrapper.find('.super-form.initialized').length!=0){
				...
				//setTimeout(function(){
					...
					if($settings.slide=='none'){
						$this.fadeIn(parseInt($settings.fade_duration));  
					}
					// Slide from bottom
					if($settings.slide=='from_bottom'){
	...
	SUPER.init_popups.hide = function() {
		...
		$settings = jQuery.parseJSON($settings);
		if( $settings.disable_closing!='true' ) {
			$wrapper.fadeOut(parseInt($settings.fade_out_duration/2), function() {
